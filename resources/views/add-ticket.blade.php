                    ...
                    <div class="col-xl-10 mx-auto">
                        <div id="user-activity" class="card">
                            <div class="card-header border-0 pb-0 d-sm-flex d-block">
                                <div>
                                    <h4 class="card-title mb-1">Add ticket</h4>
                                </div>
                                        ...
                                        <div class="ml-0 ml-sm-4 ml-sm-0">
                                            <div class="toolbar mb-4" role="toolbar">
                                                ...
                                                <div class="compose-content">
                                                    ...
                                                    <textarea id="email-compose-editor" name="subject" class="textarea_editor form-control bg-transparent" rows="5" placeholder="Description"></textarea>
                                                    </div>
