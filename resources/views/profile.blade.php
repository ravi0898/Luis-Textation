                    ...
                    <div class="col-xl-12">
                        <div id="user-activity" class="card">
                            <div class="card-header border-0 pb-0 d-sm-flex d-block">
                                <div>
                                    <h4 class="card-title mb-1">Profile</h4>
                                </div>
         ...
         <div class="card-body">
           ...
           <form method="POST" action="{{ url('profile_update') }}">
             ...
             <div class="row">
                <div class="col-sm-6">
                    <label>Name</label>
                   <input type="text" class="form-control" name="client_name" placeholder="" value="{{ $client_name }}">
                </div>
                ...
                <div class="col-sm-6 mt-2 mt-sm-0">
                 ...
                 <div class="col-sm-6 mt-2 mt-sm-3">
                    <label>Number</label>
               <input type="text" class="form-control bdr" name="mobile_no" value="{{ $mobile_no }}" placeholder="">
                                        </div>
                 </div>
